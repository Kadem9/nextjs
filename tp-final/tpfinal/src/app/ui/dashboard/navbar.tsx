        ...
        <nav className="bg-emerald-950 p-4">
            <div className="flex justify-between items-center">
                ...
                <div className="navigation flex">
                    <Link href="/accueil" className={clsx('mr-2 p-2', { 'bg-red-600 text-red-300': pathname === "/rendez-vous" })} >
                        <span className='flex items-center'>
                            <FontAwesomeIcon width={20} icon={faHouse} className='mr-1' />
                            Accueil
                        </span>
                    </Link>
                    <Link href="/patient" className={clsx('mr-2 p-2', { 'bg-sky-100 text-red-300': pathname === "/rendez-vous" })} >
                        <span className='flex items-center'>
                            <FontAwesomeIcon width={20} icon={faHospitalUser} className='mr-1' />
                            Patients
                        </span>
                    </Link>
                    <Link href="/rendez-vous" className={clsx('mr-2 p-2', { 'bg-sky-100 text-red-300': pathname === "/rendez-vous" })} >
                        <span className='flex items-center'>
